...
<%@ page import="urbanmanagement.model.FloorInfo" %>
...
var stationLayer=new OpenLayers.Layer.Vector('Registered Floor Information');

<g:each in="${floorInfoInstanceList}" status="i" var="floorInfo">

var point${floorInfo.id}=dynamicStationLayer(${floorInfo.flCenterLongitude}, ${floorInfo.flCenterLatitude})
pointFeatures.push(point${floorInfo.id}); 
...
#output-id {margin: 10px 20px;}
 ...
 <b>Number of Registered Floor:<b>${floorInfoTotal}
