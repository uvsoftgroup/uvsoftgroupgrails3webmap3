...
var stationLayer=new OpenLayers.Layer.Vector('Registred Plot Infomation');


<g:each in="${plotInfoList}" status="i" var="plotInfo">

var point${plotInfo.id}=dynamicStationLayer(${plotInfo.plCenterLongitude}, ${plotInfo.plCenterLatitude})
pointFeatures.push(point${plotInfo.id}); 
...
#output-id {margin: 10px 20px;}
 ...
 <b>Number of Registered Plot:<b>${counter}
 <table>
 <tr>
 <td width="20%">
<table>
<th>Click Position Longitude</th>
<th>Click Position Latitude</th>
<tr>
